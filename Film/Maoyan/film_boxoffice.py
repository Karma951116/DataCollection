...
class FilmBoxOfficeCrawler:
    ...
    def get_response(self, film_id):
        ...
        headers = {
            ...
            'Cookie': '_lxsdk_cuid=1766f5f7d67c8-0624e350695b8c-c791039-1fa400-1766f5f7d67c8;'
                      ' recentCis=1%3D151%3D140%3D84%3D197; theme=moviepro;'
                      ' _bsin_180503_=[1,10,11,12,13,14,15,16,17,2,3,4,5,6,7,8,9];'
                      ' __mta=217831081.1608186388084.1611284339235.1611284872037.63;'
                      ...
                      ' __mta=217831081.1608186388084.1611725519405.1611725574394.102; Hm_lpvt_703e94591e87be68cc8da0da7cbd0be2=1611725577;'
                      ' _lx_utm=utm_source%3DBaidu%26utm_medium%3Dorganic;'
                      ' _lxsdk_s=177433f58a4-aa3-4b3-b4a%7C1097461883%7C5',
    ...
    def get_day_boxoffice(self, dict_data):
        ...
        for item in data_list:
            box_office = item['box']
            split_box_office = item['splitBox']
            ...
            dict_data_after = {}
            dict_data_after['box_office'] = box_office
            dict_data_after['split_box_office'] = split_box_office
    ...
    def write_db(self, dict_summary_info, dict_day_boxoffice, film_id):
        ...
        for key in dict_day_boxoffice:
            ...
            if self.operator.search(sql).__len__() > 0:
                ...
                sql = 'insert into maoyan_film_boxday (filmId, date, boxOffice, splitBoxOffice)' \
                      'values(%d, %s, %f, %f)' % (film_id, dict_day_boxoffice[key], dict_day_boxoffice[key]['box_office'],
        ...
        day_boxoffice = '[数量: %d,已存在: %d, 成功: %d, 失败: %d]' % \
    ...
    def check_data(self, dict_data):
        if dict_data['boxInfoData'] == [] or dict_data['boxInfoData'] is None:
            return 1
        else:
            return 0
...
def official_method():
    ...
    for num in range(offset, film_id_list.__len__()):
        ...
        cfo.write_film_boxoffice('current_offset', num.__str__())
        time.sleep(25)
